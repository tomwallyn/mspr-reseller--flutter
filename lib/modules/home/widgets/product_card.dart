...
class ProductCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Stack(
              children: [
                Image.asset("assets/graphic/cafe1.png",
                    width: 182, height: 182),
                Positioned(
                  top: 16,
                  right: 16,
                  child: Image.asset('assets/graphic/icons/like_icon.png',
                      width: 28, height: 28),
                )
              ],
            ),
  ...
  Widget _buildSoldPoint(double star, int sold) {
    return Row(
      children: [
        Image.asset('assets/graphic/icons/star_icon.png',
            width: 20, height: 20),
